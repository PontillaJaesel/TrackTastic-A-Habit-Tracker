...
public class Weekly extends Habit {
    ...
    public void createHabit(String tag) {
        ...
        for (int day : selectedDays) {
            switch (day) {
                case 1: daysInitials.append("M"); break;
                case 2: daysInitials.append("T"); break;
                case 3: daysInitials.append("W"); break;
                case 4: daysInitials.append("Th"); break;
                case 5: daysInitials.append("F"); break;
                case 6: daysInitials.append("Sat"); break;
                case 7: daysInitials.append("S"); break;
                default: break;
            }
            daysInitials.append(",");
        }
        ...
        habitDAO.addHabit(habitName, habitDescription, "0", habitGoal, tag);
    ...
    public boolean printHabits(int type, int indicator) {
        ...
        List<String> habits = habitDAO.getAllHabits();
    ...
    public void updateStatus(int indicator) {
        if (printHabits(0, 0)) {
            ...
            String[] habitDetails = habitDAO.getHabitDetails(habitToEdit);
    ...
    public void deleteHabits() {
        ...
        if (habits.contains(habitToDelete)) {
